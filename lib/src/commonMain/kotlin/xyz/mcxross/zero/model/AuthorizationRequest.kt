...
data class AuthorizationRequest(
     ...
     * appropriate validation of the state in the authorization response. It is recommended that the
     * default implementation of this parameter be used wherever possible. Typically used to prevent
     ...
     * {@link #codeVerifierChallengeMethod challenge method}. If a code verifier is not being used
     * for this request, this value will be `null`.
     *
     * @see "Proof Key for Code Exchange by OAuth Public Clients (RFC 7636)
     *
     * <https://tools.ietf.org/html/rfc7636>"
...
fun AuthorizationRequest.toUri(): Uri {
  ...
  if (codeVerifier != null) {
    uriBuilder.appendQueryParameter(
        AuthorizationRequest.PARAM_CODE_CHALLENGE, codeVerifierChallenge)
    uriBuilder.appendQueryParameter(
        AuthorizationRequest.PARAM_CODE_CHALLENGE_METHOD, codeVerifierChallengeMethod)
  }

  uriBuilder.appendQueryParameterIfNotNull(
      AuthorizationRequest.PARAM_RESPONSE_MODE, responseMode?.value)
