...
data class AuthorizationResponse(
    ...
    /**
     * The returned state parameter, which must match the value specified in the request. AppAuth
     * for Android ensures that this is the case.
     */
     ...
     * {@link AuthorizationRequest#responseType response_type} of the request included 'token'.
     *
     * @see "OpenID Connect Core 1.0, Section 3.2.2.5
     *
     * <https://openid.net/specs/openid-connect-core-1_0.html#rfc.section.3.2.2.5>"
