...
/**
 * Convenience wrapper around [android.util.Log], which evaluates the current log level of
...
object Logger {
    ...
    @VisibleForTesting
    const val LOG_TAG = "Zero"

    @VisibleForTesting
    @Volatile
    var sInstance: Logger? = null
    ...
    /**
     * The core interface of [android.util.Log], converted into instance methods so as to
